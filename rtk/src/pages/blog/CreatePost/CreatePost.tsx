...
import { useAddPostMutation, useGetOnePostQuery, useUpdatePostMutation } from "../blog.services";
import { useSelector, useDispatch } from "react-redux";
import { cancelUpdatingPost } from "../blog.reducer";
...
export default function CreatePost() {
  ...
  const [formData, setFormData] = useState<Omit<Post, "id"> | Post>(initialFormData);
  const editPostId = useSelector((state: RootState) => state.blog.postId);
  const { data } = useGetOnePostQuery(editPostId, { skip: !editPostId });
