...
import { startUpdatingPost } from "../blog.reducer";
import { useDispatch } from "react-redux";
import { useDeletePostMutation } from "../blog.services";
interface Props {
  post: Post;
}
export default function PostItem(props: Props) {
  const { post } = props;
  const [deletePostt] = useDeletePostMutation();
        ...
        <div>
          <div className="inline-flex rounded-md shadow-sm" role="group">
            <button
              ...
              onClick={() => dispatch(startUpdatingPost(post.id))}
            >
              Edit
            </button>
            <button
